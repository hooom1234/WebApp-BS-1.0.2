...
useFocusEffect(
  ...
  const Edit_Select = (id) => {
    ...
    .then((json) => {
      ...
      navigation.navigate("UpdateAdmin", {
        id: json.id,
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          text: "ยืนยัน",
          onPress: () => {
            fetch(`http://52.221.184.135/API/Admin-System/AdminManage/AdminDelete.php?id=${id}`, {
              method: 'DELETE',
            })
              .then((response) => response.json())
              .then((json) => {
  ...
  <Text style={styles.headerText}>Admin Account</Text>
