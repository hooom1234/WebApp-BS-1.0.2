...
const AdminAdminButton = () => {
  ...
  return (
    <Pressable
      onPress={() => navigation.navigate("AdminAdmin")}
    ...
    >
      <Animated.View style={[styles.button, { transform: [{ scale: scaleAnim }] }]}>
        <View style={styles.iconContainer}>
          <Image
            source={require("../../../../assets/logo/admin-logo.png")}
            style={styles.icon}
          />
        </View>
        <Text style={styles.text}>ผู้ดูแลระบบ</Text>
      </Animated.View>
    </Pressable>
  );
};
...
export default AdminAdminButton;
