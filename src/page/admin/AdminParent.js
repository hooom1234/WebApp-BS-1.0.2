...
import AdminAdminButton from "./button/AdminParent";

const { width, height } = Dimensions.get('window');

const AdminParent = ({ route, navigation }) => {
...
useFocusEffect(
  ...
  const Edit_Select = (id) => {
    ...
    .then((json) => {
      ...
      navigation.navigate("UpdateParent", {
        id: json.id,
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.logoContainer}>
          <AdminAdminButton style={styles.logo} />
        </View>
...
>
  <Text style={styles.addButtonText}>+ เพิ่มผู้ปกครอง</Text>
</TouchableOpacity>
